...
5️⃣ page.locator('.ui-xxx')                 ← 最後手段（僅限 PrimeNG 內部元素）
```
...
> 📄 完整規範：`accessibility-testing-standards-20260224v1.1.md`  
> ☑️ 檢查表：`accessibility-review-checklist-20260224v1.1.md`
